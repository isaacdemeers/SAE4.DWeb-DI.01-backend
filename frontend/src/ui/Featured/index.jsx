...
export default function Featured({ movie }) {
  ...
  return (
    <section className=' w-screen h-[40vh] md:h-screen relative mb-60 md:mb-0'>
      ...
      <nav className="-translate-y-20">
        <div className='flex align-middle justify-between w-full px-2 md:absolute md:w-auto md:justify-start md:px-0 md:top-[-23rem] md:ml-10 md:m-auto'>

          <Button type="action" style="none" text="" additionalStyles='md:hidden' icon='infosIcon' ></Button>
          <Button type="link" link={`viewMovie/${movie.id}`} style="noPad" imgAdditionalStyles="w-[100px] h-[100px] md:w-[80px] md:h-[80px]" text="" icon='playIcon-big' ></Button>
        ...
        <div className=' z-40 flex flex-col align-middle justify-center gap-3 md:absolute md:top-[-40rem] md:ml-10 md:justify-start md:m-auto'>
          <p className='text-white font-medium m-auto uppercase text-[4rem] w-full text-center md:text-left'>{movie['name']}</p>
