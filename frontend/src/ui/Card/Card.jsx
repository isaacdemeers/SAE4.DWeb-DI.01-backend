  ...
  return (
    ...
    <Link to={'/viewMovie/' + data['id']}>
      ...
      <figure className="card flex relative items-center justify-center flex-col  w-[fit-content] rounded-2xl">
        ...
        <section className="cardPreview bg-dark bg-gray-800 md:flex z-50 hidden justify-start items-start flex-col overflow-hidden h-[fit-content] rounded-2xl w-[300px] [transition:all_.3s] absolute top-2/4 left-2/4 -translate-x-1/2 -translate-y-1/2 opacity-0  origin-[0_0]">
