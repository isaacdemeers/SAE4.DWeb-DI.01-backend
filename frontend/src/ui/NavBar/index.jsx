...
export default function NavBar() {
  return (
    <nav className="bg-black md:hidden fixed bottom-0 z-40 left-0 w-full text-white py-4">
      <ul className="flex align-middle justify-evenly">
        <li className=" cursor-pointer flex flex-col items-center text-[.4rem]">
        ...
        <li className=" cursor-pointer  text-[.4rem]">
