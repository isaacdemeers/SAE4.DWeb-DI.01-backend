...
export default function Button({ type, ...props }) {
  ...
  let styles = {
    ...
    live: ' text-sm hidden md:block cursor-pointer rounded-md px-3 py-1 bg-red-600 text-white',
  ...
  let icon = '';
  if (props.icon) {
    icon = <img className={'w-[20px] h-[20px] ' + props.imgAdditionalStyles} src={'../public/assets/icons/' + props.icon + '.svg'} alt="logo" />;
  }
